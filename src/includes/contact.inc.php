...
$headers  = 'MIME-Version: 1.0' . "\r\n".
    ...
    'From: Contact | Escape room Excido kanker@kanker.nl'."\r\n".
    'Reply-To: kanker@kanker.nl'."\r\n" .
...
if (mail($email, "Contact Form", getSuccessfullySendTemplate($subject, $message), $headers) &&
    ...
    header("Location: ../php/contact.php?message=Bericht_Verzonden");
    exit();
} else {
    header("Location: ../php/contact.php?message=Iets ging mis bij ons.");
    exit();
}
